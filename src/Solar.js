    ...
    return (
        <div className="App">
            ...
            <div className="container">
                <iframe
                    src="https://csiro-project-code-5ntnyi7jq2gyh3s23m4nid.streamlit.app//?embed=true"
                    height="950"
            ...
            <div className="container">
                <iframe
                    src="https://csiro-project-code-sm6d9jxzjpjesxpu5vz7xy.streamlit.app//?embed=true"
                    height="950"
                    style={{ width: '100%', border: 'none' }}
                ></iframe>
            </div>
